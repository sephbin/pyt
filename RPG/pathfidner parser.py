...
fvttdir = r"C:\Users\Andrew\OneDrive - Cox Architecture Pty Ltd\Documents\FVTT\Data\systems\pf1\packs"
fvttdir = r"C:\Users\Andrew\OneDrive - Cox Architecture Pty Ltd\Documents\FVTT\Data\worlds\ultima-thule\packs"
...
for a in actor:
	...
	# pp.pprint(outOb)
	# print("-"*80)
	for dir_file in os.listdir(fvttdir):
		filename = os.fsdecode(dir_file)
		if filename.endswith(".db"):
			rf = os.path.join(fvttdir, filename)
			# print(rf)
			writeOb = []
			with open(rf, "r", encoding="utf8") as f:
				...
				for line_index, l in enumerate(lines):
					try:
						l = json.loads(l)
						if outOb["title"] == l["name"]:
							# print("MATCH", outOb["title"])
							# print(l)
							# for item in l["items"]:
								# print(item["name"],item["type"],item["sort"],item["data"]["tag"])
								# itemTemplate = {"_id": "", "name": "", "type": "", "sort": 0, "flags": {}, "img": "", "effects": [], "data": {"ability": {"attack": None, "damage": None, "damageMult": 1, "critRange": 20, "critMult": 2 }, "abilityType": "", "actionType": None, "activation": {"cost": 1, "type": ""}, "armorProf": {"value": [], "custom": ""}, "associations": {"classes": [] }, "attack": {"parts": [] }, "attackBonus": "", "attackName": "", "attackNotes": "", "attackParts": [], "changeFlags": {"loseDexToAC": False, "noEncumbrance": False, "mediumArmorFullSpeed": False, "heavyArmorFullSpeed": False, "noStr": False, "noDex": False, "oneInt": False, "oneWis": False, "oneCha": False }, "changes": [], "contextNotes": [], "critConfirmBonus": "", "crOffset": "", "damage": {"parts": [], "critParts": [], "nonCritParts": [] }, "description": {"value": "", "chat": "", "unidentified": ""}, "disabled": False, "duration": {"value": None, "units": ""}, "effectNotes": "", "featType": "feat", "flags": {"boolean": [], "dictionary": [] }, "formula": "", "formulaicAttacks": {"count": {"formula": "", "value": None }, "bonus": {"formula": ""}, "label": None }, "links": {"children": [], "charges": [] }, "measureTemplate": {"type": "", "size": "0", "overrideColor": False, "customColor": "", "overrideTexture": False, "customTexture": ""}, "nonlethal": False, "range": {"value": None, "units": "", "maxIncrements": 1, "minValue": None, "minUnits": "", "long": None }, "save": {"dc": 0, "type": "", "description": ""}, "showInQuickbar": False, "soundEffect": "", "tag": "", "tags": [], "target": {"value": ""}, "unchainedAction": {"activation": {"cost": 1, "type": ""} }, "useCustomTag": False, "uses": {"value": 0, "max": 0, "per": None, "autoDeductCharges": True, "autoDeductChargesCost": "1"}, "weaponProf": {"value": [], "custom": ""} } }
								# diff = DeepDiff(item, itemTemplate)
							...
							lAppend = []
							keyList = [
							{"dictKey":"type", "update": {"type":"class","sort":100000,"data":{"tags":["class"]}}},
							{"dictKey":"defensive_abilities", "update": {"type":"feat","sort":100000,"data":{"tags":["defensive_abilities"]}}},
							{"dictKey":"defensive_abilities_immune", "update": {"type":"feat","sort":100000,"data":{"tags":["defensive_abilities_immune"]}}},
							{"dictKey":"special_qualities", "update": {"type":"feat","sort":100000,"data":{"tags":["special_qualities"]}}},
							{"dictKey":"special_attacks", "update": {"type":"attack","sort":100000,"data":{"tags":["special_attacks"]}}},
							{"dictKey":"feats", "update": {"type":"feat","sort":100000,"data":{"tags":["feats"]}}},
							]
							for keyFunction in keyList:
								# itemTemplate = {"_id": "", "name": "", "type": "", "sort": 0, "flags": {}, "img": "", "effects": [], "data": {"ability": {"attack": None, "damage": None, "damageMult": 1, "critRange": 20, "critMult": 2 }, "abilityType": "", "actionType": None, "activation": {"cost": 1, "type": ""}, "armorProf": {"value": [], "custom": ""}, "associations": {"classes": [] }, "attack": {"parts": [] }, "attackBonus": "", "attackName": "", "attackNotes": "", "attackParts": [], "changeFlags": {"loseDexToAC": False, "noEncumbrance": False, "mediumArmorFullSpeed": False, "heavyArmorFullSpeed": False, "noStr": False, "noDex": False, "oneInt": False, "oneWis": False, "oneCha": False }, "changes": [], "contextNotes": [], "critConfirmBonus": "", "crOffset": "", "damage": {"parts": [], "critParts": [], "nonCritParts": [] }, "description": {"value": "", "chat": "", "unidentified": ""}, "disabled": False, "duration": {"value": None, "units": ""}, "effectNotes": "", "featType": "", "flags": {"boolean": [], "dictionary": [] }, "formula": "", "formulaicAttacks": {"count": {"formula": "", "value": None }, "bonus": {"formula": ""}, "label": None }, "links": {"children": [], "charges": [] }, "measureTemplate": {"type": "", "size": "0", "overrideColor": False, "customColor": "", "overrideTexture": False, "customTexture": ""}, "nonlethal": False, "range": {"value": None, "units": "", "maxIncrements": 1, "minValue": None, "minUnits": "", "long": None }, "save": {"dc": 0, "type": "", "description": ""}, "showInQuickbar": False, "soundEffect": "", "tag": "", "tags": [], "target": {"value": ""}, "unchainedAction": {"activation": {"cost": 1, "type": ""} }, "useCustomTag": False, "uses": {"value": 0, "max": 0, "per": None, "autoDeductCharges": True, "autoDeductChargesCost": "1"}, "weaponProf": {"value": [], "custom": ""} } }
								iterate = outOb[keyFunction["dictKey"]]
								if type(iterate) != type([]):
									iterate = [iterate]
								for element in iterate:
									# print(element)
									if element:
										itemTemplate = {"_id": ''.join(random.choice(string.ascii_uppercase + string.ascii_lowercase) for _ in range(16)), "name": "", "type": "", "sort": 0, "flags": {}, "img": "icons/svg/mystery-man.svg", "effects": [], "data": {"ability": {"attack": None, "damage": None, "damageMult": 1, "critRange": 20, "critMult": 2 }, "abilityType": "", "actionType": None, "activation": {"cost": 1, "type": ""}, "armorProf": {"value": [], "custom": ""}, "associations": {"classes": [] }, "attack": {"parts": [] }, "attackBonus": "", "attackName": "", "attackNotes": "", "attackParts": [], "changeFlags": {"loseDexToAC": False, "noEncumbrance": False, "mediumArmorFullSpeed": False, "heavyArmorFullSpeed": False, "noStr": False, "noDex": False, "oneInt": False, "oneWis": False, "oneCha": False }, "changes": [], "contextNotes": [], "critConfirmBonus": "", "crOffset": "", "damage": {"parts": [], "critParts": [], "nonCritParts": [] }, "description": {"value": "N/A", "chat": "", "unidentified": ""}, "disabled": False, "duration": {"value": None, "units": ""}, "effectNotes": "", "featType": "feat", "flags": {"boolean": [], "dictionary": [] }, "formula": "", "formulaicAttacks": {"count": {"formula": "", "value": None }, "bonus": {"formula": ""}, "label": None }, "links": {"children": [], "charges": [] }, "measureTemplate": {"type": "", "size": "0", "overrideColor": False, "customColor": "", "overrideTexture": False, "customTexture": ""}, "nonlethal": False, "range": {"value": None, "units": "", "maxIncrements": 1, "minValue": None, "minUnits": "", "long": None }, "save": {"dc": 0, "type": "", "description": ""}, "showInQuickbar": False, "soundEffect": "", "tag": "", "tags": [], "target": {"value": ""}, "unchainedAction": {"activation": {"cost": 1, "type": ""} }, "useCustomTag": False, "uses": {"value": 0, "max": 0, "per": None, "autoDeductCharges": True, "autoDeductChargesCost": "1"}, "weaponProf": {"value": [], "custom": ""} } }
										itemTemplate["name"] = element
										itemTemplate= deepUpdate(itemTemplate, keyFunction["update"])
										lAppend.append(itemTemplate)
									# print(itemTemplate)
							# lAppend.append(l["items"][0])
							# l["items"] = lAppend.copy()
							# print(json.dumps(l))
							writeOb.append(json.dumps(l))
						else:
							print(l["name"])
							writeOb.append(json.dumps(l))
					except Exception as e:
